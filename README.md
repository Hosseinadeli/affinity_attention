...
1. [affinity_attention_spread_Transformer_demo Colab](https://colab.research.google.com/drive/1maUewiNxNXvm_OxEj_GMzi4fiHboNXyQ?usp=sharing) shows how affiniyt spread can be used to spread attention in a an object with features from a self-supervised vision transformer. 

2. [affinity_attention_spread_CNN_demo Colab](https://colab.research.google.com/drive/16Ba_7ZPb2ptPdkBvSyzXNN3p2IftpJny?usp=sharing) shows how affiniyt spread can be used to spread attention in a an object with features from a CNN. 
